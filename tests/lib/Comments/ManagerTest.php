...
class ManagerTest extends TestCase {
	...
	public function testSaveNew() {
		...
		$this->assertArrayHasKey('commentId', $calledBeforeCreateEvent[1]);
		$this->assertArrayHasKey('message', $calledBeforeCreateEvent[1]);
		$this->assertArrayHasKey('status', $calledBeforeCreateEvent[1]);
		...
		$this->assertArrayHasKey('status', $calledAfterCreateEvent[1]);
	...
	public function testSaveUpdate() {
		...
		\OC::$server->getEventDispatcher()->addListener('common.afterupdate', function (GenericEvent $event) use (&$calledAfterUpdateEevnt) {
		...
		$this->assertInstanceOf(GenericEvent::class, $calledAfterUpdateEevnt);
		$this->assertInstanceOf(GenericEvent::class, $calledBeforeUpdateEevnt);
